        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item  open ">
                ...
                <ul class="menu-content">
                    ...
                    <li>
                        <a class="menu-item" href="{{route('create.admin.languages')}}" data-i18n="nav.dash.crypto">أضافة لغه جديده</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li>
                        <a class="menu-item" href="{{route('create.admin.mainCategories')}}" data-i18n="nav.dash.crypto">اضافه قسم جديد</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('create.admin.vendors')}}" data-i18n="nav.dash.crypto">أضافة
                            متجر  </a>
                    </li>
                </ul>
            </li>
