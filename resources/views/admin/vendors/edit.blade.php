                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('update.admin.vendors',$vendors -> id)}}" method="POST"
                                            ...
                                            <div class="form-body">
                                                                ...
                                                                <optgroup label="من فضلك أختر القسم ">
                                                                    @if($categories && $categories -> count() > 0)
                                                                        @foreach($categories as $category)
                                                                            <option
                                                                                value="{{$category -> id }}"
                                                                                @if($vendors -> category_id == $category ->id)selected @endif
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> ايميل المتجر  </label>
                                                    ...
                                                    <div class="col-md-6 ">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> الموبايل</label>
                                                            <input type="text" value="{{$vendors -> mobile}}" id="mobile"
                                                                   class="form-control"
                                                                   placeholder=" "
                                                                   name="mobile">
                                                            @error("mobile")
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$vendors -> address}}" id="pac-input"
                                                                   class="form-control"
                                                                   placeholder= ""
                                                                   name="address">
                                                            @error("address")
